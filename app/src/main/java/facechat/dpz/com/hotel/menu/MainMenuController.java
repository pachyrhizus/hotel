package facechat.dpz.com.hotel.menu;
    ...
    class MenuItemAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null) //don't reuse
            {
                ...
                menuItem = (LinearLayout) ((LayoutInflater)parent.getContext().
                        getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.menu_item, null);
